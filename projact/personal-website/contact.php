                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <!-- to get an API token!-->
                                <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="handel/handelcontact.php" method="POST">
                                    <!-- Name input-->
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button type="submit" class="btn btn-primary btn-lg"
              style="padding-left: 2.5rem; padding-right: 2.5rem;">send</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
